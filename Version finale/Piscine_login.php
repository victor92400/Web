...
<h1 align="center"> Bienvenue sur ECEIN</h1>

<div class="wrapper">
<button class="button button4" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Login</button>
<button class="button button4" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">S'inscrire</button>
</div>
<div class="wrapper">
