...
<h1 align="center"> Ajouter un utilisateur</h1>

<div class="wrapper">
<button class="button button4" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Inscrire</button>
</div>
